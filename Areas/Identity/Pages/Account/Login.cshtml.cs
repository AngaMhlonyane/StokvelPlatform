...
public class LoginModel : PageModel
{
    ...
    public LoginModel(SignInManager<CustomIdentity> signInManager,UserManager<CustomIdentity> userManager, ILogger<LoginModel> logger)
    {
    ...
    public async Task<IActionResult> OnPostAsync(string returnUrl = null)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if(user != null)
            {
                ...
                if (!confirmed)
                {
                    return RedirectToPage("./AccountWarning",new { userId = user.Id });
                }
            }
